...
const pusher = new Pusher('9fde00db4b74f43f457a', {
  cluster: 'ap2'
}); 
  ...
  return (
    <div className="app">
      ...
      <div className='app__header'>
        <img className='app__headerImage' src='https://e7.pngegg.com/pngimages/779/61/png-clipart-logo-idea-cute-eagle-leaf-logo-thumbnail.png' alt='Header'/>
